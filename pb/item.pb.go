...
func (x *ItemData) GetItemType() uint32 {
	if x != nil {
		return x.ItemType
	}
	return 0
...
func (x *ItemData) GetAmount() uint64 {
	if x != nil {
		return x.Amount
	}
	return 0
...
var file_item_proto_rawDesc = []byte{
	...
	0x6f, 0x74, 0x6f, 0x22, 0x6a, 0x0a, 0x08, 0x49, 0x74, 0x65, 0x6d, 0x44, 0x61, 0x74, 0x61, 0x12,
	0x10, 0x0a, 0x03, 0x69, 0x64, 0x78, 0x18, 0x01, 0x20, 0x01, 0x28, 0x04, 0x52, 0x03, 0x69, 0x64,
	0x78, 0x12, 0x1b, 0x0a, 0x09, 0x69, 0x74, 0x65, 0x6d, 0x5f, 0x74, 0x79, 0x70, 0x65, 0x18, 0x02,
	...
	0x11, 0x0a, 0x0f, 0x47, 0x65, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x22, 0x39, 0x0a, 0x10, 0x47, 0x65, 0x74, 0x49, 0x74, 0x65, 0x6d, 0x73, 0x52, 0x65,
...
var file_item_proto_goTypes = []interface{}{
	(*ItemData)(nil),         // 0: proto.ItemData
	(*GetItemsRequest)(nil),  // 1: proto.GetItemsRequest
	(*GetItemsResponse)(nil), // 2: proto.GetItemsResponse
}
var file_item_proto_depIdxs = []int32{
	0, // 0: proto.GetItemsResponse.items:type_name -> proto.ItemData
